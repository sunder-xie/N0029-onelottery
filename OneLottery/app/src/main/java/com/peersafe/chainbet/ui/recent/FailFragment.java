...
import com.peersafe.chainbet.ui.adapter.LotteryFailAdapter;
 ...
 * DESCRIPTION :
 */
public class FailFragment extends LazyFragment implements OnItemClickListener
{
    private LRecyclerViewAdapter mLRecyclerViewAdapter = null;
    private LotteryFailAdapter mDataAdapter = null;
    ...
    private List<OneLottery> failLotteres = null;
    ...
    {
        mRecyclerView = (LRecyclerView) getView().findViewById(R.id.fail_list);
        ...
        mDataAdapter = new LotteryFailAdapter(getActivity());
    ...
    private void setDataList()
    {
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                failLotteres = OneLotteryDBHelper.getInstance().getFailLotteres();
                getActivity().runOnUiThread(new Runnable()
                {
                    @Override
                    public void run()
                    {
                        if (null != failLotteres && !failLotteres.isEmpty())
                        {
                            mLyNoData.setVisibility(View.GONE);
                            mDataAdapter.setDataList(failLotteres);
                        } else
                        {
                            mLyNoData.setVisibility(View.VISIBLE);
    ...
    public void onItemClick(View view, int position)
    {
        ...
        intent.putExtra(ConstantCode.CommonConstant.LOTTERYID, failLotteres.get(position)
                .getLotteryId());
